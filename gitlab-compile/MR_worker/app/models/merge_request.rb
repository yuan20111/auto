...
class MergeRequest < ActiveRecord::Base
  ...
  #validates_presence_of :assignee_id, :message => "必须选择审核人"
  validate :validate_version_num?, on: :create
  validate :validate_mr_validation?, on: :create  
  #validate :validate_title?, on: :create
  #validate :validate_description?, on: :create 
